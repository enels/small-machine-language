 ...
 * @author ...
 */
public final class TranslatorInjection {
    ...
    public TranslatorInjection(String fileName) {
    ...
    private Instruction getInstruction(String label, Machine machine) {
        ...
        switch (opcode) {
            ...
            case SubInstruction.OP_CODE : {
                String d = scan(true);
                String s = scan(false);
                return new SubInstruction(label, getSource(s,machine), getDestination(d, machine));
            }
            ...
            /*case CmpInstruction.OP_CODE : {
                String d = scan(true);
                String s = scan(false);
                return new CmpInstruction(label, getSource(s,machine), getDestination(d, machine));
            }*/
